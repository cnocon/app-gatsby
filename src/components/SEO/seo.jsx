...
console.log(`https://cristin.io${squarePortrait}`);
  ...
  return (
    <Helmet
      ...
      meta={[
        ...
        {
          property: `og:image`,
          content: `https://cristin.io${squarePortrait}`,
        },
        {
          name: `twitter:card`,
          content: `summary`,
    ...
    >
      ...
      <script defer async type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-5ed26ab486ccf280"></script>
    </Helmet>
  )
}
